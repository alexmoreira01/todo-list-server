...
let FindTodo = (_dec = (0, _tsyringe.injectable)(), _dec2 = function (target, key) {
  return (0, _tsyringe.inject)("TodosRepository")(target, undefined, 0);
}, _dec3 = Reflect.metadata("design:type", Function), _dec4 = Reflect.metadata("design:paramtypes", [typeof _todosRepositoryInterface.TodoRepository === "undefined" ? Object : _todosRepositoryInterface.TodoRepository]), _dec(_class = _dec2(_class = _dec3(_class = _dec4(_class = class FindTodo {
